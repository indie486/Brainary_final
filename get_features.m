                ...
                if size(signal_data,2) >= fs*block_size*2
                    ...
                    if block_max_L > 0
                        ...
                        if block_L > 0
                            ...
                            features=zeros(block_L,(T_D_L+channel_L+e_div_L*6+1));
                            for block_i=1:block_L
                                ...
                                % SE_origin
                                features(block_i,T_D_L+channel_L+e_div_L*2+1:T_D_L+channel_L+e_div_L*3)=SE_origin_max;
                                features(block_i,T_D_L+channel_L+e_div_L*3+1:T_D_L+channel_L+e_div_L*4)=SE_origin_mean;

                                % SE_vs_power
                                features(block_i,T_D_L+channel_L+e_div_L*4+1:T_D_L+channel_L+e_div_L*5)=SE_power_max;
                                features(block_i,T_D_L+channel_L+e_div_L*5+1:T_D_L+channel_L+e_div_L*6)=SE_power_mean;                                

                                % data num
                                features(block_i,T_D_L+channel_L+e_div_L*6+1)=str2double(recording_id(end-1:end));
